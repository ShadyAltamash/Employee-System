...
function checkRole() {
  ...
  if (role == "employee") {
    ...
    document.querySelector(".admin-access").classList.remove("d-none");
    // document.querySelector(".schedule__container").classList.add("d-none");
  }
}
